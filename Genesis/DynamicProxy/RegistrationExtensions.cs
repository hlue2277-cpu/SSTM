...
namespace Genesis.DynamicProxy
{
    ...
    {
        private const string InterceptorsPropertyName = "DynamicProxy.RegistrationExtensions.InterceptorsPropertyName";
            ...
            params Type[] additionalInterfaces)
        {
            ...
            {
                throw new ArgumentNullException("null component registration");
            }
            ...
            this IRegistrationBuilder<TLimit, TActivatorData, TSingleRegistrationStyle> registration, ProxyGenerationOptions options)
        {
            ...
            registration.RegistrationData.ActivatingHandlers.Add((sender, e) =>
            {
                ...
                if (interceptors != null || interceptors.Length > 0)
                {
                    ...
                    ? ProxyGenerator.CreateInterfaceProxyWithTarget(theInterface, new Type[0], e.Instance, interceptors)
                    : ProxyGenerator.CreateInterfaceProxyWithTarget(theInterface, new Type[0], e.Instance, options, interceptors);
                }
            });
            ...
            params Service[] interceptorServices)
        {
            if (builder == null)
            {
                throw new ArgumentNullException("null registration builder");
            }

            if (interceptorServices == null || interceptorServices.Any(s => s == null))
            {
                throw new ArgumentNullException("null interceptor service");
            }
            ...
            params string[] interceptorServiceNames)
        {
            ...
            {
                throw new ArgumentNullException("null interceptor services names");
            }
            ...
            params Type[] interceptorServiceTypes)
        {
            ...
            {
                throw new ArgumentNullException("null interceptor service types");
            }
        ...
        private static IEnumerable<Service> GetInterceptorServices(IComponentRegistration registration, Type implType)
        {
            ...
            if (implType == null)
            {
                throw new ArgumentNullException("null impltype");
            }
