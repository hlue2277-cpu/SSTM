...
{
    public class ReserveSlotListResponse
    {
        public bool success { get; set; }
        public string errcode { get; set; }
        public ReserveSlotListData data { get; set; }
    }

    public class ReserveSlotListData
    {
        public List<ReserveSlot> reservePeriodList { get; set; }
    }
