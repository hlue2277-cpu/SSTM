...
{
    public interface IVisitBookingPrintTicketViewModel : IPrintingViewModel
    {
	...
	public class VisitBookingPrintTicketViewModel : PrintingViewModel, IVisitBookingPrintTicketViewModel
    {
		public VisitBookingPrintTicketViewModel(ILogger logger) :
			base(logger)
		{
