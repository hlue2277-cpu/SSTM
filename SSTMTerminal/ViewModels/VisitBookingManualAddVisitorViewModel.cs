...
{
    public interface IVisitBookingManualAddVisitorViewModel : IViewModel
	{
	...
	public class VisitBookingManualAddVisitorViewModel : ViewModelBase, IVisitBookingManualAddVisitorViewModel
    {
		public VisitBookingManualAddVisitorViewModel(ILogger logger) :
			base(logger)
		{
